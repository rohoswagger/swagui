  ...
  return (
    ...
    >
      <Reveal className="mx-auto w-full max-w-[62rem]">
        <div className="brand-glow bg-card relative overflow-hidden rounded-2xl border px-8 py-16 text-center shadow-[var(--shadow-raised),var(--inset-highlight)] sm:px-16">
